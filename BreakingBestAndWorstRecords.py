...
...[BreakingBestAndWorstRecordsDiagram01.png]...
...
...[BreakingBestAndWorstRecordsDiagram02.png]...

She broke her best record four times (after games 1, 2, 3, and 9) and her worst record zero times (no score during the season was lower than the one she earned
...
for points in range(1,len(scores)):
    if scores[points]>max:
        max=scores[points]
        Records[0]+=1
    if scores[points]<min:
        min=scores[points]
        Records[1]+=1
print(Records)